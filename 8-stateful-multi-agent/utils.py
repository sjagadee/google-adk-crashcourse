...
async def update_interaction_history(session_service, app_name, user_id, session_id, interaction):
    """
    ...
    try:
        ...
        # get current interaction_history
        ...
        if purchased_courses and any(purchased_courses):
            ...
            for course in purchased_courses:
                if isinstance(course, dict):
                    ...
                    purchase_date = course.get('purchase_date', 'Unknown')
                    print(f"  - Course ID: {course_id} (Purchased on: {purchase_date})")
