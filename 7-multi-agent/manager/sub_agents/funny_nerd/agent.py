...
def get_funny_joke(topic: str, tool_context: ToolContext) -> dict:
    """
    Get a funny joke about the given topic.
    """
    print(f"--- Tool: get_funny_jokes called for '{topic}' ---")
