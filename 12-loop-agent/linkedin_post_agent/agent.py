...
from .subagents.post_creater_agent.agent import initial_post_creater
from .subagents.post_refiner_agent.agent import post_refiner
from .subagents.post_reviewer_agent.agent import post_reviewer
...
root_agent = SequentialAgent(
    ...
    sub_agents=[
        initial_post_creater,  # Step 1: Generate initial post
